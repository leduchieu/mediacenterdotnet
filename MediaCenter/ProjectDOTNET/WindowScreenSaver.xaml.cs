...
{
	public partial class WindowScreenSaver
	{
        /// <summary>
        ...
        /// </summary>
        public WindowScreenSaver()
		{
			this.InitializeComponent();
			// Insert code required on object creation below this point
            this.Photos = new PhotoList(".\\Images");
		}
        public WindowScreenSaver(bool musica)
        {
            this.InitializeComponent();
            // Insert code required on object creation below this point
            this.Photos = new PhotoList(".\\Images");
            if (musica)
            {
                this.Songs = new MusicList(".\\Music");
                playingSong = 0;
        ...
        private void endSong(object sender, RoutedEventArgs e)
        {
